...
public class ButtonExtendM extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        //记录View被按下时的背景色
        ColorStateList colorListPress = a
                .getColorStateList(R.styleable.ButtonExtendM_backColorPress);
        ...
        //设置两个控件之间的间距
        spacing = a.getDimensionPixelSize(R.styleable.ButtonExtendM_spacing, Tools.dp2px(8));
        //设置两个控件的位置结构
    ...
    public void setIconStyle(int style) {
        ...
        switch (style) {
            case STYLE_ICON_LEFT:
                ...
                lp.width = Tools.dp2px(20);
                lp.height = Tools.dp2px(20);
    ...
    public void setSpacing(int spacing) {
        this.spacing = Tools.dp2px(spacing);
